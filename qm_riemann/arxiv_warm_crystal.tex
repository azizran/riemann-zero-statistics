...
\emph{dark}: the median $|\hat G|$ over $978$ off-line frequencies (of $1200$
scanned) is $2\times10^{-4}$, a factor $\sim 25$ \emph{below} the shot-noise level
...
the Bragg comb, at $4$--$18$ times the local dark floor, of the
...
sentence: \emph{the bending of the regressions is consistent, in
location and magnitude, with the thermal diffuse scattering of the zero
crystal.}
