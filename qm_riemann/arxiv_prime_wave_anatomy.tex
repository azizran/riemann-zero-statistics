...
its validated range to eighteen orders of magnitude in $t$. At single-gap scale, two thirds or more of the apparent randomness of
...
analysis, as one would expect if absorption is nearly complete there. We also note the clean linear onset
