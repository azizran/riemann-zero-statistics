...
(4) account for the $+1\%$ to $+12\%$ drift of $u_q$; (5) settle the
$\tau \to 0$ limit of the transmission --- full transparency $w(0) = 1$
versus a plateau near the extrapolated $0.94$ --- which requires dense
small-$\tau$ coverage; (6) recover the discriminating power of the
$N_{\mathrm{eff}}$ test at large heights, which needs $\gtrsim 10^5$
consecutive zeros there (e.g.\ from the Platt/LMFDB datasets).
