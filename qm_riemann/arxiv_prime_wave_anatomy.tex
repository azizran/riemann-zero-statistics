...
observed gap; the unfolded own gap $\tilde\delta_n = g_n L/2\pi$ and $\tilde\delta_n^2$
enter the regression as covariates) and a zero-displacement channel (coefficient $v_p$: the
...
Odlyzko tables (repository folder \texttt{bagimsiz\_dogrulama/}) reproduced the sum rule
($u = 1.001$--$1.008$ over thirteen primes) and the $v(\tau)$ collapse at
the $10^{21}$-st and $10^{22}$-nd zeros (ratios to the $10^{12}$ window
$0.995 \pm 0.147$ and $1.000 \pm 0.142$). Errors are the author's.
