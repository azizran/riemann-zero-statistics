...
\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth]{fig_neff_en.png}
\caption{The effective-dimension shift $N_{\mathrm{eff}} - L$ across all
twelve windows, for Pearson-based (left) and Spearman-based (right)
matching. Each is constant in $L$; the two constants differ.}
\label{fig:neff}
\end{figure}
