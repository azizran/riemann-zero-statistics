...
Computational assistance, literature search and drafting: Claude
(Anthropic). An independent re-implementation of the core measurements, written from scratch with a different AI assistant (DeepSeek) and run on the raw Odlyzko tables (repository folder \texttt{bagimsiz\_dogrulama/}) reproduced the correlation table in
