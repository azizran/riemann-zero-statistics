...
session of this project (over $t \in [50, 500]$, $\approx 260$ gaps,
grid-based extraction) this null gave
$r_{\mathrm{null}} = 0.505 \pm 0.048$ over $30$ trials against the zeta
value $r = 0.825$ on the same range: an excess at the $6\sigma$ level. The
